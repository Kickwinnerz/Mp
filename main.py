...
<body>
    <div class="container">
      ...
      <h1>𝗗𝗘𝗩𝗜 𝗢𝗡𝗙𝗜𝗥𝗘 𝘼𝙐𝙏𝙊𝘽𝙊𝙏</h1>
        ...
        <h3>© 𝟐𝟎𝟐𝟓 DEVI 𝐀𝐥𝐥 𝐑𝐢𝐠𝐡𝐭𝐬 𝐑𝐞𝐬𝐞𝐫𝐯𝐞𝐝.</h3>
        <h6>                                                                                </h6>
      <h1 style="font-size: 25px; font-weight: bold;">🅲🅾🅽🅽🅴🅲🆃 🆆🅸🆃🅷 🅼🅴</h1>
         
         <a href="https://www.facebook.com/kickwinnerz" style="color: #00008b; font-size: 18px; text-decoration: none;">
